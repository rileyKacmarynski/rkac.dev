...
<ExternalLink href="https://github.com/tailwindcss/typography/blob/master/README.md">
...
```js showLineNumbers title="tailwind.config.js" {1-3}
module.exports = {
  purge: [],
  theme: {
    extend: {},
...
```tsx showLineNumbers title="header.tsx"
